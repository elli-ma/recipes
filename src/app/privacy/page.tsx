...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://family-cook.ru/privacy/",
  },
};
...
export default function PrivacyPolicy() {
  return (
    <div className="py-6 md:py-8">
      ...
      <div>
        <h1 className="text-2xl md:text-4xl font-black mb-4 md:mb-6 text-green-900 uppercase">Политика конфиденциальности</h1>
