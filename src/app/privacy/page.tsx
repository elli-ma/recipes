...
export const metadata: Metadata = {
  title: "Политика конфиденциальности - How to Cook",
  description: "Политика конфиденциальности How to Cook. Узнайте, как мы собираем, используем и защищаем вашу персональную информацию.",
  keywords: "политика конфиденциальности, защита данных, персональные данные, how to cook",
};
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                ...
                функциональные возможности сайта How to Cook (далее — Сайт).
              </p>
              <p className="text-gray-700">
