...
export function Newsletter() {
  return (
    <section className="py-8 md:py-16 rounded-2xl mb-8 md:mb-16 ">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <form className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
          ...
          />
          <Button type="submit" size="lg" className="bg-green-900 hover:bg-green-800 text-white font-semibold uppercase">
            Подписаться
          </Button>
        </form>
      </div>
